        ...
        <Card variant="dark" className="overflow-hidden rounded-[2rem] p-0">
          <div className="grid gap-8 px-6 py-10 sm:px-10 lg:grid-cols-[1.02fr_0.98fr] lg:px-14 lg:py-14">
            <SectionHeader
              ...
              title="Book a steadier standard for your space."
              description="Tell us about the property and schedule. We will recommend the right plan and send a clear quote."
              invert
              ...
              <div className="flex flex-col justify-between gap-8 rounded-[1.5rem] border border-surface-500/20 bg-surface-0/5 p-6">
                <div className="space-y-3">
                  ...
                  <p className="text-sm leading-6 text-surface-200">
                    Most inquiries can be quoted after a short conversation about size, frequency, and priorities.
                  </p>
                </div>
