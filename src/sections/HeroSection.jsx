          ...
          <div className="relative" data-reveal="image">
            ...
            <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_9.5rem]">
              <div className="image-shell relative aspect-[0.92] rounded-[2.25rem]">
                ...
                <div
                  className="absolute bottom-4 left-4 right-4 max-w-[13rem] rounded-[1.5rem] bg-surface-0/92 p-4 shadow-card backdrop-blur"
                  data-reveal="soft"
              ...
              <div className="grid gap-4">
                <div className="image-shell aspect-[0.86] rounded-[1.5rem]" data-reveal="image" style={{ '--reveal-order': 2 }}>
                  <img
